...
$ apt-get update && apt-get install -y libsndfile1 # sndfile library not found

$ pip install PySoundFile
$ pip install --upgrade PySoundFile audioread librosa


make_vqvae block_kwargs:

'restore_vqvae': 'https://openaipublic.azureedge.net/jukebox/models/5b/vqvae.pth.tar'
'train': False
'prior': False

prior_level_0: raw_to_token = 8
prior_level_1: raw_to_token = 32
prior_level_2: raw_to_token = 128


python jukebox/sample.py --model=5b --name=reconstructed --sample_length_in_seconds=30 --audio_file=samples --sr=44100 --levels=3
